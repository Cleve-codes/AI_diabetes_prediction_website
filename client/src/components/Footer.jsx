      ...
      <div className="container mx-auto flex flex-col md:flex-row justify-start items-start px-4 md:px-15 lg:px-100 space-y-8 md:space-y-0">
        ...
        <div className="w-full md:w-1/4 mb-8 md:mb-0">
          ...
          <div className="flex space-x-4 text-2lg">
            <a href="https://twitter.com/cleve_codes/" className="text-white hover:text-gray-400 transition-colors duration-300">
              <img src='https://img.icons8.com/?size=100&id=fJp7hepMryiw&format=png&color=ffffff' alt="X Logo" className="w-8 h-8" />
            </a>
            <a href="https://www.instagram.com/abaga._" className="text-white hover:text-gray-400 transition-colors duration-300">
              <FaInstagram className="text-2xl" />
            </a>
            <a href="https://www.linkedin.com/in/cleve-momanyi/" className="text-white hover:text-gray-400 transition-colors duration-300">
              <FaLinkedinIn className="text-2xl" />
            </a>
            <a href="https://github.com/Cleve-codes/" className="text-white hover:text-gray-400 transition-colors duration-300">
              <FaGithub className="text-2xl" />
            </a>
            <a href="https://quora.com/profile/" className="text-white hover:text-gray-400 transition-colors duration-300">
